...
namespace ActivatorObject03
{
    ...
    std::future<std::vector<std::future<std::tuple<std::size_t, std::size_t, std::size_t>>>>
    enqueueTasksAsynchronously(ActiveObject& activeObject, std::size_t start, std::size_t length, std::size_t count) {
