...
namespace PlacementNew {
    ...
    static void test_placement_new_00()
    {
    ...
    static void test_placement_new_05()
    {
        size_t capacity{ 10 };
    ...
    static void test_placement_new_06()
    {
        VectorEx<Point> vec;
...
void test_placement_new ()
{
    ...
    //test_placement_new_00();
    //test_placement_new_01();
    //test_placement_new_02();
    //test_placement_new_03();

    //test_placement_new_04();
    //test_placement_new_05();
    test_placement_new_06();
}