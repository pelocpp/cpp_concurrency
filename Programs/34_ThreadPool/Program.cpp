...
extern void test_concurrency_thread_pool10_PrimeNumbers();   // computing prime numbers, using free function
extern void test_concurrency_thread_pool11_PrimeNumbers();   // computing prime numbers, using lambda
